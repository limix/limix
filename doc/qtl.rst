...
.. doctest::
    ...
    traits   = ['0' '1']
    M        = ['offset' 'age']
    𝜶        = [-0.16350602 -0.00299803 -0.34521075 -0.0008041 ]
    se(𝜶)    = [11.3057377   0.09640183  5.36091349  0.0457362 ]
    diag(C₀) = [0.01405138 0.29152818]
    diag(C₁) = [0.81176402 0.85780814]
    lml      = -277.3341862283916
    <BLANKLINE>
    Hypothesis 1
    ============
    <BLANKLINE>
